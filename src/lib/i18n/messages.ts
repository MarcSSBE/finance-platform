...
const en = {
  ...
  amazon: {
    ...
    provisionalNote:
      "Filenames are provisional until Veronica confirms her naming spec. Nothing else changes when she does.",
    colInvoice: "Invoice",
    colCountry: "Country",
    colType: "Type",
    colDate: "Date",
    colAmount: "Total",
    docMerchant: "Selling fees",
    docFba: "FBA fees",
...
const sv: Messages = {
  ...
  amazon: {
    ...
    provisionalNote:
      "Filnamnen är preliminära tills Veronica bekräftar sin namnstandard. Inget annat ändras när hon gör det.",
    colInvoice: "Faktura",
    colCountry: "Land",
    colType: "Typ",
    colDate: "Datum",
    colAmount: "Summa",
    docMerchant: "Försäljningsavgifter",
    docFba: "FBA-avgifter",
    docCredit: "Kreditnota",
    docEpr: "EPR-tjänst",
    docOther: "Faktura",
    readByAi: "Läst av AI, bekräfta beloppet",
    fileToDrive: "Arkivera till Google Drive",
